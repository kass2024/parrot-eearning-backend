...
<head>
    ...
    <style>
        ...
        .header { background:#065f46; color:#f9fafb; padding:20px 28px; }
        ...
        .btn { display:inline-block; margin-top:12px; padding:10px 18px; background:#059669; color:#ffffff !important; text-decoration:none; border-radius:999px; font-size:13px; font-weight:600; }
